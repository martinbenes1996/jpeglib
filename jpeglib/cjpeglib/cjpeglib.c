...
#define MAX_MARKER 20
      ...
      BITMASK *flags)
  {
    ...
    if (flags != NULL)
    {
      // PROGRESSIVE_MODE 0b00010000
      // cinfo.progressive_mode 0xf1 or 0x00
      ...
      unsigned short *qt)
  {
    ...
    {
      if (dct[ch] == NULL)
        continue; // skip component, if null
      ...
      BITMASK flags)
  {
    ...
    unsigned short stride = (overwrite_flag(flags, QUANTIZE_COLORS) && flag_is_set(flags, QUANTIZE_COLORS)) ? 1 : cinfo.out_color_components;
